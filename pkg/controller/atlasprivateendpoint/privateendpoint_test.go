...
func TestHandlePrivateEndpointService(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"private endpoint service is initiating": {
			atlasPrivateEndpoint: &akov2.AtlasPrivateEndpoint{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "pe1",
					Namespace: "default",
		...
		"private endpoint service is pending": {
			atlasPrivateEndpoint: &akov2.AtlasPrivateEndpoint{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "pe1",
					Namespace: "default",
		...
		"private endpoint service is being deleted": {
			atlasPrivateEndpoint: &akov2.AtlasPrivateEndpoint{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "pe1",
					Namespace: "default",
	...
	for name, tt := range tests {
		t.Run(name, func(t *testing.T) {
			...
			result, err := r.handlePrivateEndpointService(&workflowCtx, projectID, tt.atlasPrivateEndpoint)
...
func TestDeletePrivateEndpoint(t *testing.T) {
	...
	for name, tt := range tests {
		t.Run(name, func(t *testing.T) {
			...
			_, err := r.deletePrivateEndpoint(ctx, projectID, tt.peService)
			assert.Equal(t, tt.expectedErr, err)
		})
	}
}
