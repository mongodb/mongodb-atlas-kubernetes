...
func ensurePrivateEndpoint(workflowCtx *workflow.Context, project *akov2.AtlasProject, protected bool) workflow.Result {
	canReconcile, err := canPrivateEndpointReconcile(workflowCtx.Context, nil, protected, project)
	if err != nil {
...
func canPrivateEndpointReconcile(ctx context.Context, atlasClient *mongodbatlas.Client, protected bool, akoProject *akov2.AtlasProject) (bool, error) {
	...
	// TODO: This needs to be wired correctly once ownership detection is enabled again!
	list, err := getAllPrivateEndpoints(ctx, nil, akoProject.ID())
	if err != nil {
		return false, err
	}
