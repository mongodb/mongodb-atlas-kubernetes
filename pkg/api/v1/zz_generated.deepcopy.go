...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiskGBEnabled) DeepCopyInto(out *DiskGBEnabled) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiskGBEnabled.
func (in *DiskGBEnabled) DeepCopy() *DiskGBEnabled {
	if in == nil {
		return nil
	}
	out := new(DiskGBEnabled)
