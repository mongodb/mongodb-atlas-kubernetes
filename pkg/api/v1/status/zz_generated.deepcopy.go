...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AtlasCustomRoleProjectStatus) DeepCopyInto(out *AtlasCustomRoleProjectStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AtlasCustomRoleProjectStatus.
func (in *AtlasCustomRoleProjectStatus) DeepCopy() *AtlasCustomRoleProjectStatus {
	if in == nil {
		return nil
	}
	out := new(AtlasCustomRoleProjectStatus)
	in.DeepCopyInto(out)
	return out
}
