...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProjectTeamRef) DeepCopyInto(out *ProjectTeamRef) {
	*out = *in
	out.TeamRef = in.TeamRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProjectTeamRef.
func (in *ProjectTeamRef) DeepCopy() *ProjectTeamRef {
	if in == nil {
		return nil
	}
	out := new(ProjectTeamRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProjectTeamStatus) DeepCopyInto(out *ProjectTeamStatus) {
	*out = *in
	if in.Teams != nil {
		...
		*out = make([]ProjectTeamRef, len(*in))
		copy(*out, *in)
	}
}
