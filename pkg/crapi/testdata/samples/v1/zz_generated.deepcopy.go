...
func (in *BackupCompliancePolicySpecV20250312) DeepCopyInto(out *BackupCompliancePolicySpecV20250312) {
	*out = *in
	...
	if in.OverwriteBackupPolicies != nil {
		in, out := &in.OverwriteBackupPolicies, &out.OverwriteBackupPolicies
		*out = new(bool)
		**out = **in
	}
}
...
func (in *DataFederationSpecV20250312) DeepCopyInto(out *DataFederationSpecV20250312) {
	*out = *in
	...
	if in.SkipRoleValidation != nil {
		in, out := &in.SkipRoleValidation, &out.SkipRoleValidation
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicationSpecsRegionConfigs) DeepCopyInto(out *ReplicationSpecsRegionConfigs) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicationSpecsRegionConfigs.
func (in *ReplicationSpecsRegionConfigs) DeepCopy() *ReplicationSpecsRegionConfigs {
	if in == nil {
		return nil
	}
	out := new(ReplicationSpecsRegionConfigs)
	in.DeepCopyInto(out)
	return out
}
	...
	*out = *in
	...
	if in.RegionConfigs != nil {
		...
		*out = new([]ReplicationSpecsRegionConfigs)
		if **in != nil {
			in, out := *in, *out
			*out = make([]ReplicationSpecsRegionConfigs, len(*in))
			for i := range *in {
				(*in)[i].DeepCopyInto(&(*out)[i])
			}
		}
