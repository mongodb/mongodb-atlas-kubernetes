...
import (
	...
	integrationssdk "go.mongodb.org/atlas-sdk/v20250312015/admin"
	zap "go.uber.org/zap"
...
type Handler struct {
	...
	handlerintegrations ctrlstate.VersionedHandlerFunc[integrationssdk.APIClient, akov2generated.Parent]
}

func NewParentReconciler(
	c cluster.Cluster,
	...
	if err != nil {
		return nil, fmt.Errorf("failed to get translator set for Parent: %w", err)
	}
	...
	parentHandler := &Handler{
		AtlasReconciler: reconciler.AtlasReconciler{
			...
			Log:             logger.Named("controllers").Named("AtlasParent").Sugar(),
		},
