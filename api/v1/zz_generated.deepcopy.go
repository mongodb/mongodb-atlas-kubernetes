...
func (in *ReadPreference) DeepCopyInto(out *ReadPreference) {
	*out = *in
	if in.TagSets != nil {
		...
		*out = make([][]ReadPreferenceTag, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = make([]ReadPreferenceTag, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReadPreferenceTag) DeepCopyInto(out *ReadPreferenceTag) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReadPreferenceTag.
func (in *ReadPreferenceTag) DeepCopy() *ReadPreferenceTag {
	if in == nil {
		return nil
	}
	out := new(ReadPreferenceTag)
	in.DeepCopyInto(out)
	return out
}
