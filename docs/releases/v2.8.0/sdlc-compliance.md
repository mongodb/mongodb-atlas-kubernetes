SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.8.0
=================================================================

- Release Creators: roo.thorp@mongodb.com
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.8.0, 2025-03-06.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.8.0 SIGNATURE_REPO=mongodb/signatures
    ```
