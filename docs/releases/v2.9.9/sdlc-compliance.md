SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.9.9
=================================================================
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.9.9 SIGNATURE_REPO=mongodb/signatures
    ```
