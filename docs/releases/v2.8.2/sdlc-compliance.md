SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.8.2
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.8.2, 2025-06-05.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.8.2 SIGNATURE_REPO=mongodb/signatures
    ```
