SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.5.0
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.5.0, 2024-10-28.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.5.0 SIGNATURE_REPO=mongodb/signatures
    ```
