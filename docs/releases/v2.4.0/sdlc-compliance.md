SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.4.0
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.4.0, 2024-07-16.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.4.0 SIGNATURE_REPO=mongodb/signatures
    ```
