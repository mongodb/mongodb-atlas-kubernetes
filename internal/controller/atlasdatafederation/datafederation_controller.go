...
func (r *AtlasDataFederationReconciler) Reconcile(context context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	endpointService := datafederation.NewDatafederationPrivateEndpoint(clientSet.SdkClientLatest.DataFederationApi)
	dataFederationService := datafederation.NewAtlasDataFederation(clientSet.SdkClientLatest.DataFederationApi)
