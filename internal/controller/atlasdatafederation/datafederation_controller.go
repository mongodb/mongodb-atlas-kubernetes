...
func (r *AtlasDataFederationReconciler) Reconcile(context context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	endpointService := datafederation.NewDatafederationPrivateEndpoint(clientSet.SdkClient20250312014.DataFederationApi)
	dataFederationService := datafederation.NewAtlasDataFederation(clientSet.SdkClient20250312014.DataFederationApi)
