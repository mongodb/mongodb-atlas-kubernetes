...
// nolint:dupl
const ThirdPartyIntegrationBySecretIndex = "thirdpartyintegration.apiKeySecretRef,licenseKeySecretRef,microsoftTeamsWebhookUrlSecretRef,readTokenSecretRef,routingKeySecretRef,secretSecretRef,serviceKeySecretRef,apiTokenSecretRef,passwordSecretRef,urlSecretRef,writeTokenSecretRef"
...
func (i *ThirdPartyIntegrationBySecretIndexer) Keys(object client.Object) []string {
	...
	if resource.Spec.V20250312.Entry.ApiKeySecretRef != nil && resource.Spec.V20250312.Entry.ApiKeySecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.ApiKeySecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.LicenseKeySecretRef != nil && resource.Spec.V20250312.Entry.LicenseKeySecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.LicenseKeySecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.MicrosoftTeamsWebhookUrlSecretRef != nil && resource.Spec.V20250312.Entry.MicrosoftTeamsWebhookUrlSecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.MicrosoftTeamsWebhookUrlSecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.ReadTokenSecretRef != nil && resource.Spec.V20250312.Entry.ReadTokenSecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.ReadTokenSecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.RoutingKeySecretRef != nil && resource.Spec.V20250312.Entry.RoutingKeySecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.RoutingKeySecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.SecretSecretRef != nil && resource.Spec.V20250312.Entry.SecretSecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.SecretSecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.ServiceKeySecretRef != nil && resource.Spec.V20250312.Entry.ServiceKeySecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.ServiceKeySecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.ApiTokenSecretRef != nil && resource.Spec.V20250312.Entry.ApiTokenSecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.ApiTokenSecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.PasswordSecretRef != nil && resource.Spec.V20250312.Entry.PasswordSecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.PasswordSecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.UrlSecretRef != nil && resource.Spec.V20250312.Entry.UrlSecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.UrlSecretRef.GetObject(resource.Namespace).String())
	}
	if resource.Spec.V20250312.Entry.WriteTokenSecretRef != nil && resource.Spec.V20250312.Entry.WriteTokenSecretRef.Name != "" {
		keys = append(keys, resource.Spec.V20250312.Entry.WriteTokenSecretRef.GetObject(resource.Namespace).String())
	}
	return keys
}
