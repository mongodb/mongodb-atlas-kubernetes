...
type CustomRoleHandlerv20250312 struct {
...
func NewCustomRoleHandlerv20250312(atlasProvider atlas.Provider, client client.Client, log *zap.SugaredLogger, globalSecretRef client.ObjectKey) *CustomRoleHandlerv20250312 {
	return &CustomRoleHandlerv20250312{
...
func (h *CustomRoleHandlerv20250312) HandleInitial(ctx context.Context, customrole *v1.CustomRole) (ctrlstate.Result, error) {
...
func (h *CustomRoleHandlerv20250312) HandleImportRequested(ctx context.Context, customrole *v1.CustomRole) (ctrlstate.Result, error) {
...
func (h *CustomRoleHandlerv20250312) HandleImported(ctx context.Context, customrole *v1.CustomRole) (ctrlstate.Result, error) {
...
func (h *CustomRoleHandlerv20250312) HandleCreating(ctx context.Context, customrole *v1.CustomRole) (ctrlstate.Result, error) {
...
func (h *CustomRoleHandlerv20250312) HandleCreated(ctx context.Context, customrole *v1.CustomRole) (ctrlstate.Result, error) {
...
func (h *CustomRoleHandlerv20250312) HandleUpdating(ctx context.Context, customrole *v1.CustomRole) (ctrlstate.Result, error) {
...
func (h *CustomRoleHandlerv20250312) HandleUpdated(ctx context.Context, customrole *v1.CustomRole) (ctrlstate.Result, error) {
...
func (h *CustomRoleHandlerv20250312) HandleDeletionRequested(ctx context.Context, customrole *v1.CustomRole) (ctrlstate.Result, error) {
...
func (h *CustomRoleHandlerv20250312) HandleDeleting(ctx context.Context, customrole *v1.CustomRole) (ctrlstate.Result, error) {
...
func (h *CustomRoleHandlerv20250312) For() (client.Object, builder.Predicates) {
	return &v1.CustomRole{}, builder.WithPredicates()
}

// SetupWithManager sets up the controller with the Manager
func (h *CustomRoleHandlerv20250312) SetupWithManager(mgr controllerruntime.Manager, rec reconcile.Reconciler, defaultOptions controller.Options) error {
