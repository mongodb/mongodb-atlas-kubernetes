...
func (h *Handler) getHandlerForResource(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.StateHandler[akov2generated.CustomRole], error) {
	atlasClients, err := h.getSDKClientSet(ctx, customrole)
	if err != nil {
		return nil, err
	}
	// Check which resource spec version is set and validate that only one is specified
	var versionCount int
	var selectedHandler ctrlstate.StateHandler[akov2generated.CustomRole]

	if customrole.Spec.V20250312 != nil {
		translationReq, err := getTranslationRequest(ctx, h.Client, "customroles.atlas.generated.mongodb.com", "v1", "v20250312")
		if err != nil {
			return nil, err
		}
		versionCount++
...
func (h *Handler) HandleInitial(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.Result, error) {
	handler, err := h.getHandlerForResource(ctx, customrole)
	if err != nil {
...
func (h *Handler) HandleImportRequested(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.Result, error) {
	handler, err := h.getHandlerForResource(ctx, customrole)
	if err != nil {
...
func (h *Handler) HandleImported(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.Result, error) {
	handler, err := h.getHandlerForResource(ctx, customrole)
	if err != nil {
...
func (h *Handler) HandleCreating(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.Result, error) {
	handler, err := h.getHandlerForResource(ctx, customrole)
	if err != nil {
...
func (h *Handler) HandleCreated(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.Result, error) {
	handler, err := h.getHandlerForResource(ctx, customrole)
	if err != nil {
...
func (h *Handler) HandleUpdating(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.Result, error) {
	handler, err := h.getHandlerForResource(ctx, customrole)
	if err != nil {
...
func (h *Handler) HandleUpdated(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.Result, error) {
	handler, err := h.getHandlerForResource(ctx, customrole)
	if err != nil {
...
func (h *Handler) HandleDeletionRequested(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.Result, error) {
	handler, err := h.getHandlerForResource(ctx, customrole)
	if err != nil {
...
func (h *Handler) HandleDeleting(ctx context.Context, customrole *akov2generated.CustomRole) (ctrlstate.Result, error) {
	handler, err := h.getHandlerForResource(ctx, customrole)
	if err != nil {
...
func (h *Handler) For() (client.Object, builder.Predicates) {
	obj := &akov2generated.CustomRole{}
	return obj, builder.WithPredicates(h.predicates...)
}
func (h *Handler) customroleForGroupMapFunc() handler.MapFunc {
	return indexer.ProjectsIndexMapperFunc(indexers.CustomRoleByGroupIndex, func() *akov2generated.CustomRoleList {
		return &akov2generated.CustomRoleList{}
	}, indexers.CustomRoleRequestsFromGroup, h.Client, h.Log)
}
...
func (h *Handler) SetupWithManager(mgr controllerruntime.Manager, rec reconcile.Reconciler, defaultOptions controller.Options) error {
	...
	return controllerruntime.NewControllerManagedBy(mgr).Named("CustomRole").For(h.For()).Watches(&akov2generated.Group{}, handler.EnqueueRequestsFromMapFunc(h.customroleForGroupMapFunc()), builder.WithPredicates(predicate.ResourceVersionChangedPredicate{})).WithOptions(defaultOptions).Complete(rec)
}

// getSDKClientSet creates an Atlas SDK client set using credentials from the resource's connection secret
func (h *Handler) getSDKClientSet(ctx context.Context, customrole *akov2generated.CustomRole) (*atlas.ClientSet, error) {
	var connectionSecretRef *client.ObjectKey
	if customrole.Spec.ConnectionSecretRef != nil {
		connectionSecretRef = &client.ObjectKey{
			Name:      customrole.Spec.ConnectionSecretRef.Name,
