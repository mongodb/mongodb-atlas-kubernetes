...
// +kubebuilder:rbac:groups=atlas.generated.mongodb.com,resources=ipaccesslistentries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=atlas.generated.mongodb.com,resources=ipaccesslistentries/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=atlas.generated.mongodb.com,resources=ipaccesslistentries/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch
// +kubebuilder:rbac:groups="",resources=events,verbs=create;patch

// +kubebuilder:rbac:groups=atlas.generated.mongodb.com,namespace=default,resources=ipaccesslistentries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=atlas.generated.mongodb.com,namespace=default,resources=ipaccesslistentries/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=atlas.generated.mongodb.com,namespace=default,resources=ipaccesslistentries/finalizers,verbs=update
...
type Handler struct {
	...
	handlerv20250312   ctrlstate.VersionedHandlerFunc[v20250312sdk.APIClient, akov2generated.IPAccessListEntry]
}

func NewIPAccessListEntryReconciler(
	c cluster.Cluster,
	...
	if err != nil {
		return nil, fmt.Errorf("failed to get translator set for IPAccessListEntry: %w", err)
	}
	// Create main handler dispatcher
	ipaccesslistentryHandler := &Handler{
		AtlasReconciler: reconciler.AtlasReconciler{
			AtlasProvider:   atlasProvider,
			Client:          c.GetClient(),
			GlobalSecretRef: globalSecretRef,
			Log:             logger.Named("controllers").Named("AtlasIPAccessListEntry").Sugar(),
		},
