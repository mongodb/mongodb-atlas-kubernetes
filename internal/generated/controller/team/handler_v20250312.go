...
type TeamHandlerv20250312 struct {
...
func NewTeamHandlerv20250312(atlasProvider atlas.Provider, client client.Client, log *zap.SugaredLogger, globalSecretRef client.ObjectKey) *TeamHandlerv20250312 {
	return &TeamHandlerv20250312{
...
func (h *TeamHandlerv20250312) HandleInitial(ctx context.Context, team *v1.Team) (ctrlstate.Result, error) {
	...
	return result.NextState(state.StateUpdated, "Updated AtlasTeam.")
}

// HandleImportRequested handles the importrequested state for version v20250312
func (h *TeamHandlerv20250312) HandleImportRequested(ctx context.Context, team *v1.Team) (ctrlstate.Result, error) {
...
func (h *TeamHandlerv20250312) HandleImported(ctx context.Context, team *v1.Team) (ctrlstate.Result, error) {
...
func (h *TeamHandlerv20250312) HandleCreating(ctx context.Context, team *v1.Team) (ctrlstate.Result, error) {
...
func (h *TeamHandlerv20250312) HandleCreated(ctx context.Context, team *v1.Team) (ctrlstate.Result, error) {
...
func (h *TeamHandlerv20250312) HandleUpdating(ctx context.Context, team *v1.Team) (ctrlstate.Result, error) {
...
func (h *TeamHandlerv20250312) HandleUpdated(ctx context.Context, team *v1.Team) (ctrlstate.Result, error) {
...
func (h *TeamHandlerv20250312) HandleDeletionRequested(ctx context.Context, team *v1.Team) (ctrlstate.Result, error) {
...
func (h *TeamHandlerv20250312) HandleDeleting(ctx context.Context, team *v1.Team) (ctrlstate.Result, error) {
...
func (h *TeamHandlerv20250312) For() (client.Object, builder.Predicates) {
	return &v1.Team{}, builder.WithPredicates()
}

// SetupWithManager sets up the controller with the Manager
func (h *TeamHandlerv20250312) SetupWithManager(mgr controllerruntime.Manager, rec reconcile.Reconciler, defaultOptions controller.Options) error {
