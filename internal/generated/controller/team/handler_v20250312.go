...
func (h *Handlerv20250312) HandleInitial(ctx context.Context, team *akov2generated.Team) (ctrlstate.Result, error) {
...
func (h *Handlerv20250312) HandleImportRequested(ctx context.Context, team *akov2generated.Team) (ctrlstate.Result, error) {
...
func (h *Handlerv20250312) HandleImported(ctx context.Context, team *akov2generated.Team) (ctrlstate.Result, error) {
...
func (h *Handlerv20250312) HandleCreating(ctx context.Context, team *akov2generated.Team) (ctrlstate.Result, error) {
...
func (h *Handlerv20250312) HandleCreated(ctx context.Context, team *akov2generated.Team) (ctrlstate.Result, error) {
...
func (h *Handlerv20250312) HandleUpdating(ctx context.Context, team *akov2generated.Team) (ctrlstate.Result, error) {
...
func (h *Handlerv20250312) HandleUpdated(ctx context.Context, team *akov2generated.Team) (ctrlstate.Result, error) {
...
func (h *Handlerv20250312) HandleDeletionRequested(ctx context.Context, team *akov2generated.Team) (ctrlstate.Result, error) {
...
func (h *Handlerv20250312) HandleDeleting(ctx context.Context, team *akov2generated.Team) (ctrlstate.Result, error) {
...
func (h *Handlerv20250312) For() (client.Object, builder.Predicates) {
	return &akov2generated.Team{}, builder.WithPredicates()
}
