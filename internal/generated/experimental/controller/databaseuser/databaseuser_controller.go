...
// +kubebuilder:rbac:groups=atlas.generated.experimental.mongodb.com,resources=databaseusers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=atlas.generated.experimental.mongodb.com,resources=databaseusers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=atlas.generated.experimental.mongodb.com,resources=databaseusers/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch
// +kubebuilder:rbac:groups="",resources=events,verbs=create;patch

// +kubebuilder:rbac:groups=atlas.generated.experimental.mongodb.com,namespace=default,resources=databaseusers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=atlas.generated.experimental.mongodb.com,namespace=default,resources=databaseusers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=atlas.generated.experimental.mongodb.com,namespace=default,resources=databaseusers/finalizers,verbs=update
...
type Handler struct {
	...
	handlerv20250312   handler.VersionedHandlerFunc[v20250312sdk.APIClient, akov2generated.DatabaseUser]
}
