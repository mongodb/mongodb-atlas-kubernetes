...
func (_m *DeploymentServiceMock) GetDeployment(ctx context.Context, projectID string, name string) (deployment.Deployment, error) {
...
//   - projectID string
//   - name string
func (_e *DeploymentServiceMock_Expecter) GetDeployment(ctx interface{}, projectID interface{}, name interface{}) *DeploymentServiceMock_GetDeployment_Call {
	return &DeploymentServiceMock_GetDeployment_Call{Call: _e.mock.On("GetDeployment", ctx, projectID, name)}
}

func (_c *DeploymentServiceMock_GetDeployment_Call) Run(run func(ctx context.Context, projectID string, name string)) *DeploymentServiceMock_GetDeployment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *DeploymentServiceMock_GetDeployment_Call) RunAndReturn(run func(context.Context, string, string) (deployment.Deployment, error)) *DeploymentServiceMock_GetDeployment_Call {
	_c.Call.Return(run)
	return _c
}
