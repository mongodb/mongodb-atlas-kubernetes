...
// Create provides a mock function with given fields: ctx, projectID, integrationType, integration, _a4, ns
func (_m *AtlasIntegrationsServiceMock) Create(ctx context.Context, projectID string, integrationType string, integration integrations.Integration, _a4 client.Client, ns string) error {
	ret := _m.Called(ctx, projectID, integrationType, integration, _a4, ns)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, integrations.Integration, client.Client, string) error); ok {
		r0 = rf(ctx, projectID, integrationType, integration, _a4, ns)
	} else {
		r0 = ret.Error(0)
	}
...
//   - _a4 client.Client
//   - ns string
func (_e *AtlasIntegrationsServiceMock_Expecter) Create(ctx interface{}, projectID interface{}, integrationType interface{}, integration interface{}, _a4 interface{}, ns interface{}) *AtlasIntegrationsServiceMock_Create_Call {
	return &AtlasIntegrationsServiceMock_Create_Call{Call: _e.mock.On("Create", ctx, projectID, integrationType, integration, _a4, ns)}
}

func (_c *AtlasIntegrationsServiceMock_Create_Call) Run(run func(ctx context.Context, projectID string, integrationType string, integration integrations.Integration, _a4 client.Client, ns string)) *AtlasIntegrationsServiceMock_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(integrations.Integration), args[4].(client.Client), args[5].(string))
	})
	return _c
}
...
func (_c *AtlasIntegrationsServiceMock_Create_Call) RunAndReturn(run func(context.Context, string, string, integrations.Integration, client.Client, string) error) *AtlasIntegrationsServiceMock_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
// Update provides a mock function with given fields: ctx, projectID, integrationType, integration, _a4, ns
func (_m *AtlasIntegrationsServiceMock) Update(ctx context.Context, projectID string, integrationType string, integration integrations.Integration, _a4 client.Client, ns string) error {
	ret := _m.Called(ctx, projectID, integrationType, integration, _a4, ns)
...
//   - _a4 client.Client
//   - ns string
func (_e *AtlasIntegrationsServiceMock_Expecter) Update(ctx interface{}, projectID interface{}, integrationType interface{}, integration interface{}, _a4 interface{}, ns interface{}) *AtlasIntegrationsServiceMock_Update_Call {
	return &AtlasIntegrationsServiceMock_Update_Call{Call: _e.mock.On("Update", ctx, projectID, integrationType, integration, _a4, ns)}
}

func (_c *AtlasIntegrationsServiceMock_Update_Call) Run(run func(ctx context.Context, projectID string, integrationType string, integration integrations.Integration, _a4 client.Client, ns string)) *AtlasIntegrationsServiceMock_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(integrations.Integration), args[4].(client.Client), args[5].(string))
	})
	return _c
...
func (_c *AtlasIntegrationsServiceMock_Update_Call) RunAndReturn(run func(context.Context, string, string, integrations.Integration, client.Client, string) error) *AtlasIntegrationsServiceMock_Update_Call {
	_c.Call.Return(run)
	return _c
}
