...
func (_m *TeamsServiceMock) AddUsers(ctx context.Context, usersToAdd *[]admin.AddUserToTeam, orgID string, teamID string) error {
...
func (_c *TeamsServiceMock_AddUsers_Call) Run(run func(ctx context.Context, usersToAdd *[]admin.AddUserToTeam, orgID string, teamID string)) *TeamsServiceMock_AddUsers_Call {
...
func (_c *TeamsServiceMock_AddUsers_Call) RunAndReturn(run func(context.Context, *[]admin.AddUserToTeam, string, string) error) *TeamsServiceMock_AddUsers_Call {
	_c.Call.Return(run)
	return _c
}
